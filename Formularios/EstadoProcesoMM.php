        ...
        <div class="consulta mt-4" id="consulta">
            ...
            <div style="margin: 0 18px;">
                ...
                if ($_SESSION['permisosMod']['c']) {
                    ...
                    <?php } ?>
                    <button class="rounded" style="background-color: #fff; color: dark; float: right;"  onclick="generarReporte('TablaEstadoProcesos','REPORTE DE ESTADO DEL PROCESO',60)">Generar PDF</button>
                </form>
            </div>
                ...
                $(document).ready(function(){          //Lee la búsqueda
                    $('#form-busqueda').submit(function(event){ 
                        ...
                        if(busqueda == "") {
                            ...
                            BuscarEstadoProcesoMM(busqueda);
                        }
                    });
                });
            </script>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <form class="InsertEstadoProceso">
                        ...
                        <input type="text" id="Descripcion"  autofocus require class="form-control" placeholder="Ingrese El Nombre Del estado del proceso">
                        <hr>

                        <div id="btnagregarEstadoProceso">
                            <input type="submit" id="btnagregar" onclick="AgregarEstadoProcesoMM()" value="Agregar Estado Del Proceso" class="btn btn-success">
