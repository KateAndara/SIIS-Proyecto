            ...
            <div class="row">
                ...
                <div class="col-12">
                    <form class="InsertContactoCliente">
                        ...
                        <input type="text" id="Contacto" autocomplete="off" class="form-control js-example-basic-single"  placeholder="Ingrese la información del contacto" oninput="validarEntrada(this)" >
                        <hr>
