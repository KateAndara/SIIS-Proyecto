...
<head>
    ...
    <title>Promociones Aplicadas</title>
    <!-- CSS only -->
    ...
    <script src="../JS/PromocionesAplicadas.js"></script>
    ...
    <div class="col-md-12 cards-white" style="margin: 0 auto; width: 110%; max-width: none; margin-left: auto; margin-right: auto">
        <div class="consulta mt-4" id="consulta">
            ...
            <form id="form-busqueda" autocomplete="off">
               <button class="rounded" style="background-color: #fff; color: dark; float: right;"  onclick="generarReporte('TablaPromocionesApli','REPORTE DE PROMOCIONES EN VENTAS',60)">Generar PDF</button>
            </form>
            </div>
            ...
            <div class="box-body">
                <div class="table table-responsive">
                    <table id="TablaPromocionesApli" class="table table-hover">
                        <thead>
                            <tr>
                                <th>ID </th>
                                <th>PROMOCION</th>
