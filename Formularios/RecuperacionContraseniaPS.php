...
<body>
  <div class="bg-black p-5 rounded-5 text-secondary shadow" style="width: 32rem">
    ...
    <div class="d-flex justify-content-center">
    <label for='titulo'>Usted está en recuperación de contraseña por el método de preguntas secretas, complete lo que se le pida.</label><br>
    </div>
    <br>
    <div class="container">
      <form class="form-horizontal" action="" method="post">
            ...
            echo "<div id='btnGuardarContraseña'>";
            echo "<input type='submit' name='btnGuardarContraseña' value='Guardar nueva contraseña' class='btn btn-info text-white w-100 mt-4 fw-semibold shadow-sm'>";
            echo "</div>";
            echo "</div>";
            echo "</form>";

            require_once("../controller/restablecerContraseniaPS.php");
