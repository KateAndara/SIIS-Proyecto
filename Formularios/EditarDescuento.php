...
$id=$_GET["id"];
$sql=$conexion->query("select * from tbl_descuentos where Id_Descuento= $id");
                    ...
                    <div class="card rounded shadow shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                while ( $datos= $sql->fetch_object()) { ?>
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" value="<?=$datos->Nombre_descuento?>" class="form-control form-control-lg rounded-0" name="NombreDescuento" id="NombreDescuento" placeholder="Descuento..." required="">
                                    <div class="invalid-feedback">Oops, te ha faltado completar este campo.</div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Porcentaje del Descuento</label>
                                    <input type="number" value="<?=$datos->Porcentaje_a_descontar?>" class="form-control form-control-lg rounded-0" name="PorcentajeDescuento" id="PorcentajeDescuento" placeholder="1,2,3,4,5..." onkeydown="this.value=Numeros(this.value)" required="" >
                                    <div class="invalid-feedback">Oops, te ha faltado completar este campo</div>
                            ...
                            ?> 
                                ...
                                <button type="submit" class="btn btn-success btn-lg float-right" name="btnEditar" id="btnEditar" onclick="ValidarForm()" value="ok">GUARDAR</button>
