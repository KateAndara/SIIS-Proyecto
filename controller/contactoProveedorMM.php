    ...
    if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
        ...
        switch($_GET["opc"]){
            ...
            case "GetContactoProveedoresMM":
                ...
                if (!isset($_SESSION['ingreso_registrado_pantalla_contactosP'])) {
                    $contactosProveedoresMM->registrar_bitacora($Id_Usuario, 46,  'Ingresar', 'Se ingresó a la pantalla de contactos de proveedores ');

                    // Marcar que el ingreso ha sido registrado para esta pantalla de ventas
                    $_SESSION['ingreso_registrado_pantalla_contactosP'] = true;
                }
