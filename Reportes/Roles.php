...
$pdf->SetAutoPageBreak(true, 20); //salto de pagina automatico
    ...
    $pdf->Cell(70,8,utf8_decode('ROL'),1,0,'C',0);  //C=Center, R=right, L=left
    $pdf->Cell(100,8,utf8_decode('DESCRIPCIÓN'),1,1,'C',0);  //C=Center, R=right, L=left
    // -------TERMINA----ENCABEZADO------------------
...
//$pdf->SetAligns(array('C','C','C','L'));
 ...
 while ($fila = mysqli_fetch_assoc($resultado)) {
    $pdf->Cell(15,8, ucwords(strtolower(utf8_decode($fila['Id_Rol']))),1,0,'C',0);
